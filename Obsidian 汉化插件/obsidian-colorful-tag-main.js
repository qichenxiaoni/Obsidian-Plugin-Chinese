...
Attribute.AttributeList = /* @__PURE__ */ new Map([
  ["prefix", new _Attribute("prefix", "Text" /* Text */, "content", "前缀")],
  ["suffix", new _Attribute("suffix", "Text" /* Text */, "content", "后缀")],
  ["background-color", new _Attribute("background-color", "Color" /* Color */, "background-color", "背景颜色")],
  ["text-color", new _Attribute("text-color", "Color" /* Color */, "color", "文本颜色")],
  ["text-size", new _Attribute("text-size", "Size" /* Size */, "font-size", "文本大小")],
  ["font-weight", new _Attribute("font-weight", "Number" /* Number */, "font-weight", "字体粗细")],
  ["border", new _Attribute("border", "Any" /* Any */, "border", "边框")],
  ["radius", new _Attribute("radius", "Size" /* Size */, "radius", "半径")],
  ["nest-tag", new _Attribute("nest-tag", "Boolean" /* Boolean */, null, "启用嵌套标记")],
  ["remove-hash", new _Attribute("remove-hash", "Boolean" /* Boolean */, null, "删除哈希值", "如果设置为True，则删除标记的‘#’。\n例如： '\u{1F60E}#Nice' => '\u{1F60E}Nice'")],
  ["remove-tag-name", new _Attribute("remove-tag-name", "Boolean" /* Boolean */, null, "移除标签名称", "设置为true以删除“标签名”。\n例如： '\u{1F60E}#Nice' => '\u{1F60E}#'")]
]);
...
var GlobalTagSetting = class extends BaseTagSetting {
  ...
  generateDOM(parent, plugin) {
    ...
    title.nameEl.createSpan().setText("全局设置");
    let body = setting.createDiv("colorful-tag-setting-body");
...
var PerTagSetting = class extends BaseTagSetting {
  ...
  generateDOM(parent, plugin, index) {
    ...
    overrideTitle.nameEl.createSpan().setText("覆盖全局设置");
    ...
    new import_obsidian6.Setting(normal).setName("标签名字").addText((cp) => {
...
var ColorfulTagSettingTab = class extends import_obsidian8.PluginSettingTab {
  ...
  display() {
    ...
    support_title.nameEl.createSpan().setText("支持彩色标签!");
    let supportBody = support.createDiv("colorful-tag-setting-body");
    supportBody.createSpan().setText("您的支持将是我改进彩色标签的动力。如果你喜欢这个插件，请考虑给我买杯咖啡。谢谢你！");
    ...
    generalTitle.nameEl.createSpan().setText("常规设置");
    let generalBody = general.createDiv("colorful-tag-setting-body");
    new import_obsidian8.Setting(generalBody).setName("启用标签细节(Beta)").addToggle((cp) => {
    ...
    new import_obsidian8.Setting(generalBody).setName("存储标签详细信息").addDropdown((cp) => {
